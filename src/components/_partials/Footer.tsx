  ...
  <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
      <div className="col-span-full lg:col-span-2">
        {/* <!-- logo - start --> */}
        <div className="lg:-mt-2 mb-4 flex">
            <Image src={logo} alt="Upsight Logo" width={100} height={50} />
            
        </div>
        {/* <!-- logo - end --> */}

        <p className="text-gray-500 sm:pr-8 mb-6">Elevate your event with UpSight: Light and Sound done right.</p>
    ...
    <div className="text-gray-400 text-sm text-center border-t py-8">© 2015 - Present Upsight. All rights reserved.</div>
  </footer>
</div>
  )
}
